...
declare const GetBatchEvaluationCommand_base: {
    new (input: GetBatchEvaluationCommandInput): import("@smithy/core/client").CommandImpl<GetBatchEvaluationCommandInput, GetBatchEvaluationCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetBatchEvaluationCommandInput): import("@smithy/core/client").CommandImpl<GetBatchEvaluationCommandInput, GetBatchEvaluationCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
