...
declare const GetEventCommand_base: {
    new (input: GetEventCommandInput): import("@smithy/core/client").CommandImpl<GetEventCommandInput, GetEventCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetEventCommandInput): import("@smithy/core/client").CommandImpl<GetEventCommandInput, GetEventCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
