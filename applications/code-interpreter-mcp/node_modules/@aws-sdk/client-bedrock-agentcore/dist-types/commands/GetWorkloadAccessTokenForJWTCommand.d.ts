...
declare const GetWorkloadAccessTokenForJWTCommand_base: {
    new (input: GetWorkloadAccessTokenForJWTCommandInput): import("@smithy/core/client").CommandImpl<GetWorkloadAccessTokenForJWTCommandInput, GetWorkloadAccessTokenForJWTCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetWorkloadAccessTokenForJWTCommandInput): import("@smithy/core/client").CommandImpl<GetWorkloadAccessTokenForJWTCommandInput, GetWorkloadAccessTokenForJWTCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
