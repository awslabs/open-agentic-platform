...
declare const UpdateABTestCommand_base: {
    new (input: UpdateABTestCommandInput): import("@smithy/core/client").CommandImpl<UpdateABTestCommandInput, UpdateABTestCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateABTestCommandInput): import("@smithy/core/client").CommandImpl<UpdateABTestCommandInput, UpdateABTestCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
