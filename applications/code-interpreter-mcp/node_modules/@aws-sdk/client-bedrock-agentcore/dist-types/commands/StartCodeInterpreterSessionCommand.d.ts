...
declare const StartCodeInterpreterSessionCommand_base: {
    new (input: StartCodeInterpreterSessionCommandInput): import("@smithy/core/client").CommandImpl<StartCodeInterpreterSessionCommandInput, StartCodeInterpreterSessionCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartCodeInterpreterSessionCommandInput): import("@smithy/core/client").CommandImpl<StartCodeInterpreterSessionCommandInput, StartCodeInterpreterSessionCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
