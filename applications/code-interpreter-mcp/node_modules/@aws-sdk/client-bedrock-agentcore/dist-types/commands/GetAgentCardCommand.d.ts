...
declare const GetAgentCardCommand_base: {
    new (input: GetAgentCardCommandInput): import("@smithy/core/client").CommandImpl<GetAgentCardCommandInput, GetAgentCardCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetAgentCardCommandInput): import("@smithy/core/client").CommandImpl<GetAgentCardCommandInput, GetAgentCardCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
