...
declare const GetBrowserSessionCommand_base: {
    new (input: GetBrowserSessionCommandInput): import("@smithy/core/client").CommandImpl<GetBrowserSessionCommandInput, GetBrowserSessionCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetBrowserSessionCommandInput): import("@smithy/core/client").CommandImpl<GetBrowserSessionCommandInput, GetBrowserSessionCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
