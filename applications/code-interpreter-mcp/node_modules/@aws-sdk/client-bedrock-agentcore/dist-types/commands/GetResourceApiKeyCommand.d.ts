...
declare const GetResourceApiKeyCommand_base: {
    new (input: GetResourceApiKeyCommandInput): import("@smithy/core/client").CommandImpl<GetResourceApiKeyCommandInput, GetResourceApiKeyCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetResourceApiKeyCommandInput): import("@smithy/core/client").CommandImpl<GetResourceApiKeyCommandInput, GetResourceApiKeyCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
