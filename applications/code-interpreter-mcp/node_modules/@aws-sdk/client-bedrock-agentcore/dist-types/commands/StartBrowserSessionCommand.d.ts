...
declare const StartBrowserSessionCommand_base: {
    new (input: StartBrowserSessionCommandInput): import("@smithy/core/client").CommandImpl<StartBrowserSessionCommandInput, StartBrowserSessionCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartBrowserSessionCommandInput): import("@smithy/core/client").CommandImpl<StartBrowserSessionCommandInput, StartBrowserSessionCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
