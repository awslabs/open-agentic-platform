...
declare const GetMemoryRecordCommand_base: {
    new (input: GetMemoryRecordCommandInput): import("@smithy/core/client").CommandImpl<GetMemoryRecordCommandInput, GetMemoryRecordCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetMemoryRecordCommandInput): import("@smithy/core/client").CommandImpl<GetMemoryRecordCommandInput, GetMemoryRecordCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
