...
declare const GetRecommendationCommand_base: {
    new (input: GetRecommendationCommandInput): import("@smithy/core/client").CommandImpl<GetRecommendationCommandInput, GetRecommendationCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetRecommendationCommandInput): import("@smithy/core/client").CommandImpl<GetRecommendationCommandInput, GetRecommendationCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
