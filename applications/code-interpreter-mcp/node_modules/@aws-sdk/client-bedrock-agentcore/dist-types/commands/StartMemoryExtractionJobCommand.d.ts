...
declare const StartMemoryExtractionJobCommand_base: {
    new (input: StartMemoryExtractionJobCommandInput): import("@smithy/core/client").CommandImpl<StartMemoryExtractionJobCommandInput, StartMemoryExtractionJobCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartMemoryExtractionJobCommandInput): import("@smithy/core/client").CommandImpl<StartMemoryExtractionJobCommandInput, StartMemoryExtractionJobCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
