...
declare const UpdateBrowserStreamCommand_base: {
    new (input: UpdateBrowserStreamCommandInput): import("@smithy/core/client").CommandImpl<UpdateBrowserStreamCommandInput, UpdateBrowserStreamCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateBrowserStreamCommandInput): import("@smithy/core/client").CommandImpl<UpdateBrowserStreamCommandInput, UpdateBrowserStreamCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
