...
declare const StartRecommendationCommand_base: {
    new (input: StartRecommendationCommandInput): import("@smithy/core/client").CommandImpl<StartRecommendationCommandInput, StartRecommendationCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartRecommendationCommandInput): import("@smithy/core/client").CommandImpl<StartRecommendationCommandInput, StartRecommendationCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
