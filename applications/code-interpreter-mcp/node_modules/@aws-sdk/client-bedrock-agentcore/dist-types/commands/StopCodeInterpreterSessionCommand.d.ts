...
declare const StopCodeInterpreterSessionCommand_base: {
    new (input: StopCodeInterpreterSessionCommandInput): import("@smithy/core/client").CommandImpl<StopCodeInterpreterSessionCommandInput, StopCodeInterpreterSessionCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopCodeInterpreterSessionCommandInput): import("@smithy/core/client").CommandImpl<StopCodeInterpreterSessionCommandInput, StopCodeInterpreterSessionCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
