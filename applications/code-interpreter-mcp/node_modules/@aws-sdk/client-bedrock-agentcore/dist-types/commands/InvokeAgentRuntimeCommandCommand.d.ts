...
declare const InvokeAgentRuntimeCommandCommand_base: {
    new (input: InvokeAgentRuntimeCommandCommandInput): import("@smithy/core/client").CommandImpl<InvokeAgentRuntimeCommandCommandInput, InvokeAgentRuntimeCommandCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: InvokeAgentRuntimeCommandCommandInput): import("@smithy/core/client").CommandImpl<InvokeAgentRuntimeCommandCommandInput, InvokeAgentRuntimeCommandCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
