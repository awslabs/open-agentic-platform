...
declare const GetResourceOauth2TokenCommand_base: {
    new (input: GetResourceOauth2TokenCommandInput): import("@smithy/core/client").CommandImpl<GetResourceOauth2TokenCommandInput, GetResourceOauth2TokenCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetResourceOauth2TokenCommandInput): import("@smithy/core/client").CommandImpl<GetResourceOauth2TokenCommandInput, GetResourceOauth2TokenCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
