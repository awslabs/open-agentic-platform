...
declare const GetPaymentInstrumentCommand_base: {
    new (input: GetPaymentInstrumentCommandInput): import("@smithy/core/client").CommandImpl<GetPaymentInstrumentCommandInput, GetPaymentInstrumentCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetPaymentInstrumentCommandInput): import("@smithy/core/client").CommandImpl<GetPaymentInstrumentCommandInput, GetPaymentInstrumentCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
