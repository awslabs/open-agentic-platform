...
declare const StopBatchEvaluationCommand_base: {
    new (input: StopBatchEvaluationCommandInput): import("@smithy/core/client").CommandImpl<StopBatchEvaluationCommandInput, StopBatchEvaluationCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopBatchEvaluationCommandInput): import("@smithy/core/client").CommandImpl<StopBatchEvaluationCommandInput, StopBatchEvaluationCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
