...
declare const GetPaymentSessionCommand_base: {
    new (input: GetPaymentSessionCommandInput): import("@smithy/core/client").CommandImpl<GetPaymentSessionCommandInput, GetPaymentSessionCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetPaymentSessionCommandInput): import("@smithy/core/client").CommandImpl<GetPaymentSessionCommandInput, GetPaymentSessionCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
