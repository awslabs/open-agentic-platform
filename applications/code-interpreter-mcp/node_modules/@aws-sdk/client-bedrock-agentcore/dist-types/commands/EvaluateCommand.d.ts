...
declare const EvaluateCommand_base: {
    new (input: EvaluateCommandInput): import("@smithy/core/client").CommandImpl<EvaluateCommandInput, EvaluateCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EvaluateCommandInput): import("@smithy/core/client").CommandImpl<EvaluateCommandInput, EvaluateCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
