...
declare const GetResourcePaymentTokenCommand_base: {
    new (input: GetResourcePaymentTokenCommandInput): import("@smithy/core/client").CommandImpl<GetResourcePaymentTokenCommandInput, GetResourcePaymentTokenCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetResourcePaymentTokenCommandInput): import("@smithy/core/client").CommandImpl<GetResourcePaymentTokenCommandInput, GetResourcePaymentTokenCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
