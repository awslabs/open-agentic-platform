...
declare const GetCodeInterpreterSessionCommand_base: {
    new (input: GetCodeInterpreterSessionCommandInput): import("@smithy/core/client").CommandImpl<GetCodeInterpreterSessionCommandInput, GetCodeInterpreterSessionCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetCodeInterpreterSessionCommandInput): import("@smithy/core/client").CommandImpl<GetCodeInterpreterSessionCommandInput, GetCodeInterpreterSessionCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
