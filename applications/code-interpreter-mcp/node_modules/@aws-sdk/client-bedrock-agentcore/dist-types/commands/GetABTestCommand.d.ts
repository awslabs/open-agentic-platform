...
declare const GetABTestCommand_base: {
    new (input: GetABTestCommandInput): import("@smithy/core/client").CommandImpl<GetABTestCommandInput, GetABTestCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetABTestCommandInput): import("@smithy/core/client").CommandImpl<GetABTestCommandInput, GetABTestCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
