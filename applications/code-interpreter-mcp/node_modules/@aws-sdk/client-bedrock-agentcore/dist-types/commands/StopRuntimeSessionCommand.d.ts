...
declare const StopRuntimeSessionCommand_base: {
    new (input: StopRuntimeSessionCommandInput): import("@smithy/core/client").CommandImpl<StopRuntimeSessionCommandInput, StopRuntimeSessionCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopRuntimeSessionCommandInput): import("@smithy/core/client").CommandImpl<StopRuntimeSessionCommandInput, StopRuntimeSessionCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
