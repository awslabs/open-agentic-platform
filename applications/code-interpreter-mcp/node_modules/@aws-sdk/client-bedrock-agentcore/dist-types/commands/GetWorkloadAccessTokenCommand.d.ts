...
declare const GetWorkloadAccessTokenCommand_base: {
    new (input: GetWorkloadAccessTokenCommandInput): import("@smithy/core/client").CommandImpl<GetWorkloadAccessTokenCommandInput, GetWorkloadAccessTokenCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetWorkloadAccessTokenCommandInput): import("@smithy/core/client").CommandImpl<GetWorkloadAccessTokenCommandInput, GetWorkloadAccessTokenCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
