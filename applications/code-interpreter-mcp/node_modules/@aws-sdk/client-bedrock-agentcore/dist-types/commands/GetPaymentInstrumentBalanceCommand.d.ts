...
declare const GetPaymentInstrumentBalanceCommand_base: {
    new (input: GetPaymentInstrumentBalanceCommandInput): import("@smithy/core/client").CommandImpl<GetPaymentInstrumentBalanceCommandInput, GetPaymentInstrumentBalanceCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetPaymentInstrumentBalanceCommandInput): import("@smithy/core/client").CommandImpl<GetPaymentInstrumentBalanceCommandInput, GetPaymentInstrumentBalanceCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
