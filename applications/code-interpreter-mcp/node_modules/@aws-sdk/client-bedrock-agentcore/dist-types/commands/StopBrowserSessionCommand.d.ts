...
declare const StopBrowserSessionCommand_base: {
    new (input: StopBrowserSessionCommandInput): import("@smithy/core/client").CommandImpl<StopBrowserSessionCommandInput, StopBrowserSessionCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopBrowserSessionCommandInput): import("@smithy/core/client").CommandImpl<StopBrowserSessionCommandInput, StopBrowserSessionCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
