...
declare const InvokeAgentRuntimeCommand_base: {
    new (input: InvokeAgentRuntimeCommandInput): import("@smithy/core/client").CommandImpl<InvokeAgentRuntimeCommandInput, InvokeAgentRuntimeCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: InvokeAgentRuntimeCommandInput): import("@smithy/core/client").CommandImpl<InvokeAgentRuntimeCommandInput, InvokeAgentRuntimeCommandOutput, import("..").BedrockAgentCoreClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
